...
use interbtc_runtime::{
	AccountId, AuraConfig, BTCRelayConfig, CurrencyId, CurrencyId::Token, CurrencyInfo, FeeConfig,
	GenesisConfig, GetWrappedCurrencyId, GrandpaConfig, IssueConfig, NominationConfig,
	OracleConfig, RedeemConfig, RefundConfig, ReplaceConfig, SecurityConfig, Signature, StatusCode,
	SudoConfig, SystemConfig, TechnicalCommitteeConfig, TokensConfig, VaultRegistryConfig,
	BITCOIN_BLOCK_SPACING, DAYS, DOT, IBTC, INTR, KBTC, KINT, KSM, WASM_BINARY,
};
...
fn expected_transaction_size() -> u32 {
	virtual_transaction_size(
		TransactionInputMetadata { count: 4, script_type: InputType::P2WPKHv0 },
		TransactionOutputMetadata { num_op_return: 1, num_p2pkh: 2, num_p2sh: 0, num_p2wpkh: 0 },
	)
}
...
fn testnet_genesis(
	...
	GenesisConfig {
		...
		issue: IssueConfig { issue_period: DAYS, issue_btc_dust_value: 1000 },
		redeem: RedeemConfig {
